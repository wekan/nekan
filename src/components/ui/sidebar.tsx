...
>(
  (
    ...
    const Comp = asChild ? Slot : "button"
    const { isMobile, state, open, setOpen } = useSidebar() // Assuming useSidebar provides access to isRTL or current language
    const { isRTL } = useTranslation(); // Get isRTL from context
