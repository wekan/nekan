...
import type { Swimlane as SwimlaneType, List as ListType, Task } from "@/lib/types"; // Aliased types
import { List } from "./List"; // Updated import
...
interface SwimlaneProps { // Renamed interface
  swimlane: SwimlaneType; // Using aliased SwimlaneType
  lists: ListType[]; // Using aliased ListType
...
export function Swimlane({ // Renamed component
  swimlane,
  lists,
  tasks,
      ...
      >
        <div className="flex items-center justify-between mb-4"> 
          ...
          <div 
            draggable={true} 
            onDragStart={(e) => { 
              const draggedElement = e.currentTarget.querySelector('h2') || e.currentTarget; // Try to drag title text, fallback to div
          ...
          {/* Removed spacer div to allow title to be left-aligned */}
        </div>
